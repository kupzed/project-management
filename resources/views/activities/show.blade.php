...
@section('header')
    <div class="flex w-full md:ml-0">
        <h1 class="text-2xl font-semibold text-gray-900">Detail Activity</h1>
    </div>
@endsection 
    ...
    <div class="max-w-3xl mx-auto">
        <div class="flex justify-between items-center">
            <div class="flex-1 min-w-0">
                ...
                <div class="my-2 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                    ...
                    <div class="my-2 flex items-center text-sm text-gray-900">
                        <span class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-gray-300 text-grey-800">
                            {{ $activity->kategori }}
                        </span>
                    </div>
                </div>
            ...
            <div class="mt-2 flex md:mt-0 md:ml-4">
                <a href="{{ route('activities.edit', $activity) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Edit Aktivitas
                </a>
            </div>
        </div>
